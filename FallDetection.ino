 ...
 // updateSerial();
  ...
  for(i=0;i<a1_size;i++)
  {
   ...
   /* Serial.print("avg is");
    ...
    //Serial.println("here22");
  }
  state(a1);
 // a1.clear();
}
void state(float a1[30])
{
  int i;
  float ans=0;
  for(i=0;i<a1_size;i++)
...
void magpathaw()
{
  ...
  updateSerial();
  mySerial.println("AT+CMGS=\"+919623417028\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
  updateSerial();
